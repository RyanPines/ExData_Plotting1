...
## CONSTRUCT PLOT TWO AND SAVE IT TO THE FOLLOWING PNG FILE: "plot2.png"

## Open the PNG Graphics Device
png("plot2.png", width = 480, height = 480)

## Construct Plot Two
with(Feb0102householdData, plot(DateAndTime, Global_active_power, type = "l", col = "black", xlab = "", ylab = "Global Active Power (kilowatts)"))
