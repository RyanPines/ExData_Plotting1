...
## CONSTRUCT PLOT ONE AND SAVE IT TO THE FOLLOWING PNG FILE: "plot1.png"

## Open the PNG Graphics Device
png("plot1.png", width = 480, height = 480)

## Construct Plot One
hist(Feb0102householdData$Global_active_power, main = "Global Active Power", col = "red", xlab = "Global Active Power (kilowatts)")
