...
## CONSTRUCT PLOT FOUR AND SAVE IT TO THE FOLLOWING PNG FILE: "plot4.png"

## Open the PNG Graphics Device
png("plot4.png", width = 480, height = 480)

## Set the number of plots per row and column (for which the plots are filled row-wise)
par(mfrow = c(2,2))

## Construct Plot Four A (the plot in the 1st row and 1st column)
with(Feb0102householdData, plot(DateAndTime, Global_active_power, type = "l", col = "black", xlab = "", ylab = "Global Active Power"))

## Construct Plot Four B (the plot in the 1st row and 2nd column)
with(Feb0102householdData, plot(DateAndTime, Voltage, type = "l", col = "black", xlab = "datetime", ylab = "Voltage"))

## Construct Plot Four C (the plot in the 2nd row and 1st column)
...
## Construct Plot Four D (the plot in the 2nd row and 2nd column)
with(Feb0102householdData, plot(DateAndTime, Global_reactive_power, type = "l", col = "black", xlab = "datetime", ylab = "Global Reactive Power"))
